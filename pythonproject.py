...
while True:
    ...
    if choice == 0:
        ...
        ax2 = ax.twinx()
        df_fig["Review Count"].plot(kind = "bar", color = "blue", ax = ax, align = "center",position = 0.3, alpha = 0.4, width = 0.5,  grid=False, title="Restaurants Near Your Searched Location")
        df_fig["Average Rating"].plot(kind = "line", color = "red", marker="o", ms = 10, ax=ax2, grid=True)
        ax.yaxis.tick_left()
